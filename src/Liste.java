...
public class Liste<T> implements List<T> {
    ...
    public Object[] toArray(Object[] a) {
        ...
        // wir wollen ja keinen zu kleinen Array und wir wollen nicht über den Rand des
        // Arrays hinausschreiben
        int limit = this.size();
        if (a.length < limit) {
        ...
        for (int i = 0; i < limit; i++) {
            ...
            // Platz für Platz wird das a array mit den Werten der diesigen Liste
            // beschrieben.
    ...
    // int limit = size();
    // if (a.length < limit) {
    // limit = a.length; // Wenn das Array zu klein ist, füllen wir nur das, was
    // geht
    // }
    // // 3. Wir füllen das Array Platz für Platz
    // for (int i = 0; i < limit; i++) {
    // // (E) ist wie ein Etikett: "Liebes Programm, behhandle diesen Wert als Typ
    // E"
